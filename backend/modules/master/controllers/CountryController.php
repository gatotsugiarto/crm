...
use common\modules\master\models\CountrySearch;
...
class CountryController extends Controller
{
    ...
    {
        // $model = new Country(['scenario' => 'insertData']);
        $model = new Country();
    ...
    public function actionReactive($id)
    {
        ...
        // Update Country        $model->status_id = 1;
        $model->save();
        ...
        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Country activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionNonactive($id)
    {
        ...
        // Update Country        $model->status_id = 2;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'Country non activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Country non activate successfully.');
        return $this->redirect(['index']);
    }
    */
