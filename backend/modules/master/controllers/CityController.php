...
use common\modules\master\models\CitySearch;
...
class CityController extends Controller
{
    ...
    {
        // $model = new City(['scenario' => 'insertData']);
        $model = new City();
    ...
    public function actionReactive($id)
    {
        ...
        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'City activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionNonactive($id)
    {
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'City non activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'City non activate successfully.');
        return $this->redirect(['index']);
    }
    */
