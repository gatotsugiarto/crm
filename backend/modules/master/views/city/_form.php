...
$title = $isNew ? 'Create New City' : 'Edit City';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new city.'
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['city/validate'],
    'action' => $isNew ? ['city/create'] : ['city/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
...
<div class="card shadow-sm border-0 rounded-4">
    <div class="modal-body px-4 pb-4">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'type')->dropDownList([ 'CITY' => 'CITY', 'REGENCY' => 'REGENCY', ], ['prompt' => '']) ?>
            </div>
        </div>
