...
$subtitle = 'Manage country data and information';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'Country_Export_'.date('YmdHis'),
...
$(document).on('beforeSubmit', '#country-form', function (e) {
    e.preventDefault();
