...
$title = $isNew ? 'Create New Country' : 'Edit Country';
$icon = $isNew ? 'fa-user-plus' : 'fa-edit';

/** @var yii\web\View $this */
/** @var common\modules\master\models\Country $model */
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new country.'
                : 'Update country information below.' ?>
        </small>
    </div>
</div>
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['country/validate'],
    'action' => $isNew ? ['country/create'] : ['country/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
