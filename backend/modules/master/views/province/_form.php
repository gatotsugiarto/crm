...
$title = $isNew ? 'Create New Province' : 'Edit Province';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new province.'
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['province/validate'],
    'action' => $isNew ? ['province/create'] : ['province/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
