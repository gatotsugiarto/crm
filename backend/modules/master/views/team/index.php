    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'Team_Export_'.date('YmdHis'),
...
$(document).on('beforeSubmit', '#team-form', function (e) {
    e.preventDefault();
