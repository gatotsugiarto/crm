...
$title = $isNew ? 'Create New PostalCode' : 'Edit PostalCode';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new postalcode.'
                : 'Update postalcode information below.' ?>
        </small>
    </div>
</div>
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['postalcode/validate'],
    'action' => $isNew ? ['postalcode/create'] : ['postalcode/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
