...
$subtitle = 'Handle postal code records efficiently';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'PostalCode_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active PostalCode',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate PostalCode',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
...
$(document).on('beforeSubmit', '#postalcode-form', function (e) {
    e.preventDefault();
