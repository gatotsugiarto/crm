...
class InvoiceController extends Controller
{
    ...
    {
        // $model = new Invoice(['scenario' => 'insertData']);
        $model = new Invoice();
    ...
    public function actionReactive($id)
    {
        ...
        // Update Invoice        $model->status_id = 1;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'Invoice activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Invoice activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionNonactive($id)
    {
        ...
        // Update Invoice        $model->status_id = 2;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'Invoice non activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Invoice non activate successfully.');
        return $this->redirect(['index']);
    }
    */
