...
use common\modules\sales\models\OpportunitySearch;
...
class OpportunityController extends Controller
{
    ...
    {
        // $model = new Opportunity(['scenario' => 'insertData']);
        $model = new Opportunity();
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                $model->getBehavior('tokenProtection')->consumeToken();
                Yii::$app->session->setFlash('success', 'Opportunity created successfully.');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                $model->getBehavior('tokenProtection')->consumeToken();
                Yii::$app->session->setFlash('success', 'Opportunity updated successfully.');
                return $this->redirect(['index']);
            }
        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', 'Opportunity deleted successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionReactive($id)
    {
        ...
        // Update Opportunity        $model->status_id = 1;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'Opportunity activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Opportunity activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionNonactive($id)
    {
        ...
        // Update Opportunity        $model->status_id = 2;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'Opportunity non activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Opportunity non activate successfully.');
        return $this->redirect(['index']);
    }
    */
