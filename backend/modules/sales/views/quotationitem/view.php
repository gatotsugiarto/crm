...
$this->title = 'Detail '.'Quotation Items';
$sub_title = 'Detailed information about this quotation item';
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <span><small><?= Yii::$app->formatter->asCurrency($model->discount) ?></small></span>
            </div>
