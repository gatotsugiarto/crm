...
$title = $isNew ? 'Create New Quotation Item' : 'Edit Quotation Item';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new quotation item.'
                : 'Update quotation item information below.' ?>
        </small>
    </div>
</div>

<?php $form = ActiveForm::begin([
    'id' => 'quotationitem-form',
    'enableAjaxValidation' => false,
    // 'validationUrl' => ['quotationitem/validate'],
    'action' => $isNew ? ['quotationitem/create'] : ['quotationitem/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
