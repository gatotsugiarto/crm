...
$this->title = 'Quotation Items';

$subtitle = 'Track all items associated with customer quotations';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'QuotationItem_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active QuotationItem',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate QuotationItem',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
        ...
        [
            ...
            'buttons' => [
                ...
                'delete' => fn($url, $model) => Html::button('<i class="fa fa-trash"></i>', [
                    ...
                    'data-url' => $url,
                    'data-name' => $model->quotation->quotation_number.' - '.$model->product->name,
                ]),
            ],
        ],
    ],
...
$(document).on('beforeSubmit', '#quotationitem-form', function (e) {
    e.preventDefault();
