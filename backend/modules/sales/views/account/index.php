...
$subtitle = 'Control and organize system accounts';
...
$gridColumns = [
    ...
    [
        ...
        'value' => function ($model) {
            return $model->parentAccount?->name ?? $model->name;
        },
    ],
    'code',
    'name',
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'Account_Export_'.date('YmdHis'),
...
$(document).on('beforeSubmit', '#account-form', function (e) {
    e.preventDefault();
