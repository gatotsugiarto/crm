...
$this->title = 'Detail '.'Contacts';
$sub_title = 'Detailed information about this contact or account';
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <span><small><?= Html::encode($model->fullname) ?></small></span>
            </div>
        </div>

        <div class="row mb-3">
            <div class="col-md-6">
                <span class="text-secondary small">Job title</span><br>
                <span><small><?= Html::encode($model->job_title ?? '-') ?></small></span>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <span class="text-secondary small">Mobile</span><br>
                <span><small><?= Html::encode($model->mobile ?? '-') ?></small></span>
            </div>
        </div>

        <div class="row mb-3">
            <div class="col-md-12">
                <span class="text-secondary small">Main Contact</span><br>
                <span>
