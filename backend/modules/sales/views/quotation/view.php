...
$this->title = 'Detail '.'Quotations';
$sub_title = 'Review pricing, items, and terms of this quote';
    ...
    <div class="d-flex gap-2">
        ...
        <?php if ($model->status !== 'Approved'): ?>
            <?= Html::a('<i class="fa fa-check"></i> Approve & Generate SO', 
                ...
                'data-confirm' => 'Approve this quotation?',
                'data-method' => 'post',
            ]) ?>
        <?php endif; ?>
...
<div class="card shadow-sm border-0 rounded-4">
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <span class="text-secondary small">Quotation number</span><br>
                <span><small><?= Html::encode($model->quotation_number) ?></small></span>
            </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <span class="text-secondary small">Quotation date</span><br>
                <span><small><?= Html::encode($model->quotation_date) ?></small></span>
                
            </div>

            <div class="col-md-6">
                <span class="text-secondary small">Valid until</span><br>
                <span><small><?= Html::encode($model->valid_until) ?></small></span>
...
<div class="mb-3">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <div>
            <div class="fw-bold" style="font-size: 15px;">
                <i class="fa fa-tags"></i>&nbsp; Quotation Items
            </div>
    ...
    <?= $this->render('@backend/modules/sales/views/quotationitem/_search', [
        'model' => $searchModel,
    ]) ?>
</div>
    ...
    'columns' => [
        ...
        [
            ...
            'value' => fn($model) => Html::a(
                Html::encode($model->quotation->quotation_number),
                'javascript:void(0);',
                [
                    'class' => 'text-primary view-data',
                    'data-url' => Url::to(['/sales/quotationitem/view', 'id' => $model->id]),
                ]
            ),
        ],
        [
...
======================================================== -->
<div class="modal fade" id="quotationitemModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            <div class="modal-body p-4"></div>
        </div>
...
<div class="modal fade" id="deletequotationitemModal" tabindex="-1">
 ...
 * ======================================================= */
$(document).on('click', '.create-quotation-item, .edit-quotation-item', function () {
    $('#quotationitemModal .modal-body').html('<div class="text-center py-5"><i class="fa fa-spinner fa-spin fa-2x text-muted"></i></div>');
    $('#quotationitemModal').modal('show').find('.modal-body').load($(this).data('url'));
});
