...
$title = $isNew ? 'Create New InvoiceItem' : 'Edit InvoiceItem';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new invoiceitem.'
                : 'Update invoiceitem information below.' ?>
        </small>
    </div>
</div>
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['invoiceitem/validate'],
    'action' => $isNew ? ['invoiceitem/create'] : ['invoiceitem/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
