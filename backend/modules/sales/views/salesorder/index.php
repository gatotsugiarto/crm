...
$subtitle = 'Manage and track confirmed customer orders';
...
$gridColumns = [
    ...
    [
        'attribute' => 'status_id',
        'value' => function ($model) {
            return $model->status0?->status_active ?? '-';
        },
    ],
    'created_at',
    [
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'SalesOrder_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active SalesOrder',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate SalesOrder',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
...
$(document).on('beforeSubmit', '#salesorder-form', function (e) {
    e.preventDefault();
