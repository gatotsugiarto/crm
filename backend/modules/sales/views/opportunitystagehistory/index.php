...
$this->title = 'Opportunity Stage Histories';

$subtitle = 'Track the history of stage changes for each opportunity';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'OpportunityStageHistory_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active OpportunityStageHistory',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate OpportunityStageHistory',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
        ...
        [
            ...
            'format' => 'raw',
            'value' => fn($model) => Html::a(
                Html::encode($model->opportunity?->name ?? '-'),
                'javascript:void(0);',
                [
                    'class' => 'text-primary view-data',
                    'data-url' => Url::to(['view', 'id' => $model->id]),
        ...
        //             'data-url' => $url,
        //             'data-name' => $model->opportunity->name,
        //         ]),
        //     ],
        // ],
    ],
...
$(document).on('beforeSubmit', '#opportunitystagehistory-form', function (e) {
    e.preventDefault();
