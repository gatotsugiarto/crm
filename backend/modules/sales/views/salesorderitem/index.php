...
use common\modules\sales\models\SalesOrderItem;

$this->title = 'Sales Order Items';

$subtitle = 'List of products and services within orders';
...
$gridColumns = [
    ...
    [
        ...
        'value' => function ($model) {
            return $model->salesOrder->order_number;
        },
    ],
    [
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'SalesOrderItem_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active SalesOrderItem',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate SalesOrderItem',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
        ...
        [
            ...
            'buttons' => [
                ...
                'delete' => fn($url, $model) => Html::button('<i class="fa fa-trash"></i>', [
                    ...
                    'data-url' => $url,
                    'data-name' => $model->salesOrder->order_number,
                ]),
            ],
        ],
    ],
