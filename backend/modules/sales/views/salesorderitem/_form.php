...
$title = $isNew ? 'Create New SalesOrderItem' : 'Edit SalesOrderItem';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new salesorderitem.'
                : 'Update salesorderitem information below.' ?>
        </small>
    </div>
</div>

<?php $form = ActiveForm::begin([
    'id' => 'salesorderitem-form',
    'enableAjaxValidation' => false,
    // 'validationUrl' => ['salesorderitem/validate'],
    'action' => $isNew ? ['salesorderitem/create'] : ['salesorderitem/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
...
<div class="card shadow-sm border-0 rounded-4">
    <div class="modal-body px-4 pb-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <?= $form->field($model, 'sales_order_id')->textInput() ?>
            </div>
