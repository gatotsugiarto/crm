...
$subtitle = 'Track all activities related to your sales and operations';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'Activity_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active Activity',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate Activity',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
...
$(document).on('beforeSubmit', '#activity-form', function (e) {
    e.preventDefault();
