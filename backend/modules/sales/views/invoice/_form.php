...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new invoice.'
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['invoice/validate'],
    'action' => $isNew ? ['invoice/create'] : ['invoice/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
...
<div class="card shadow-sm border-0 rounded-4">
    <div class="modal-body px-4 pb-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <?= $form->field($model, 'status')->dropDownList([ 'Draft' => 'Draft', 'Sent' => 'Sent', 'Paid' => 'Paid', 'Overdue' => 'Overdue', ], ['prompt' => '']) ?>
            </div>
