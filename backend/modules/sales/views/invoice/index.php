...
$subtitle = 'Handle invoicing and payments';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'Invoice_Export_'.date('YmdHis'),
        ...
        [
            ...
            'buttons' => [
                ...
                'delete' => fn($url, $model) => Html::button('<i class="fa fa-trash"></i>', [
                    ...
                    'data-url' => $url,
                    'data-name' => $model->invoice_number,
                ]),
            ],
        ],
    ],
