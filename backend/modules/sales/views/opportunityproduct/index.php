...
$this->title = 'Opportunity Products';

$subtitle = 'Manage products associated with each sales opportunity';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'OpportunityProduct_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active OpportunityProduct',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate OpportunityProduct',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
        ...
        [
            ...
            'buttons' => [
                ...
                'delete' => fn($url, $model) => Html::button('<i class="fa fa-trash"></i>', [
                    ...
                    'data-url' => $url,
                    'data-name' => $model->opportunity->name. ' - '.$model->product->name,
                ]),
            ],
        ],
    ],
