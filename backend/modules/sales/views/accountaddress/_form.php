...
$title = $isNew ? 'Create New Account Address' : 'Edit Account Address';
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new account address.'
                : 'Update account address information below.' ?>
        </small>
    </div>
</div>

<?php $form = ActiveForm::begin([
    'id' => 'accountaddress-form',
    'enableAjaxValidation' => false,
    // 'validationUrl' => ['accountaddress/validate'],
    'action' => $isNew ? ['accountaddress/create'] : ['accountaddress/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
