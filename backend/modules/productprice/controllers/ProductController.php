...
use common\modules\productprice\models\ProductSearch;
...
class ProductController extends Controller
{
    ...
    {
        // $model = new Product(['scenario' => 'insertData']);
        $model = new Product();
    ...
    public function actionReactive($id)
    {
        ...
        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Product activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionNonactive($id)
    {
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'Product non activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'Product non activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionReactive($id)
    {
        ...
        // Update Product        $model->status_id = 1;
        $model->save();
    ...
    public function actionNonactive($id)
    {
        ...
        // Update Product        $model->status_id = 2;
        $model->save();
