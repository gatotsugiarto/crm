...
class ProductpriceController extends Controller
{
    ...
    {
        // $model = new ProductPrice(['scenario' => 'insertData']);
        $model = new ProductPrice();
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                $model->getBehavior('tokenProtection')->consumeToken();
                Yii::$app->session->setFlash('success', 'Product price created successfully.');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                $model->getBehavior('tokenProtection')->consumeToken();
                Yii::$app->session->setFlash('success', 'Product price updated successfully.');
                return $this->redirect(['index']);
            }
        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', 'Product price deleted successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionReactive($id)
    {
        ...
        // Update ProductPrice        $model->status_id = 1;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'ProductPrice activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'ProductPrice activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionNonactive($id)
    {
        ...
        // Update ProductPrice        $model->status_id = 2;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'ProductPrice non activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'ProductPrice non activate successfully.');
        return $this->redirect(['index']);
    }
    */
