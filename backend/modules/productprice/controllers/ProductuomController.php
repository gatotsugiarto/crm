...
use common\modules\productprice\models\ProductUom;
use common\modules\productprice\models\ProductUomSearch;
...
class ProductuomController extends Controller
{
    ...
    {
        // $model = new ProductUom(['scenario' => 'insertData']);
        $model = new ProductUom();
        ...
        if (Yii::$app->request->isAjax) {
            if ($model->load(Yii::$app->request->post())) {
                ...
                if ($model->validate()) {
                    ...
                    return [
                        'success' => true,
                        'message' => 'ProductUom created successfully.',
                    ];
                }
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                $model->getBehavior('tokenProtection')->consumeToken();
                Yii::$app->session->setFlash('success', 'ProductUom created successfully.');
    ...
    public function actionUpdate($id)
    {
        ...
        if (Yii::$app->request->isAjax) {
            if ($model->load(Yii::$app->request->post())) {
                ...
                if ($model->validate() && $model->save()) {
                    ...
                    return [
                        'success' => true,
                        'message' => 'ProductUom updated successfully.',
                    ];
                }
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->save()) {
                $model->getBehavior('tokenProtection')->consumeToken();
                Yii::$app->session->setFlash('success', 'ProductUom updated successfully.');
                return $this->redirect(['index']);
            }
        }
    ...
    public function actionDelete($id)
    {
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'ProductUom deleted successfully.'
            ];
        }

        Yii::$app->session->setFlash('success', 'ProductUom deleted successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionReactive($id)
    {
        ...
        // Update ProductUom        $model->status_id = 1;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'ProductUom activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'ProductUom activate successfully.');
        return $this->redirect(['index']);
    }
    ...
    public function actionNonactive($id)
    {
        ...
        // Update ProductUom        $model->status_id = 2;
        $model->save();
        ...
        if (Yii::$app->request->isAjax) {
            ...
            return [
                'success' => true,
                'message' => 'ProductUom non activate successfully.',
                'errors' => $model->errors,
            ];
        }

        // fallback non-AJAX
        Yii::$app->session->setFlash('success', 'ProductUom non activate successfully.');
        return $this->redirect(['index']);
    }
    */
    ...
    {
        if (($model = ProductUom::findOne(['id' => $id])) !== null) {
            return $model;
        }
