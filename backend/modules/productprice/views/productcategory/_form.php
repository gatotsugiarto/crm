...
$title = $isNew ? 'Create New Product Category' : 'Edit Product Category';
$icon = $isNew ? 'fa-user-plus' : 'fa-edit';

/** @var yii\web\View $this */
/** @var common\modules\productprice\models\ProductCategory $model */
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new product category.'
                : 'Update product category information below.' ?>
        </small>
    </div>
</div>
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['productcategory/validate'],
    'action' => $isNew ? ['productcategory/create'] : ['productcategory/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
