...
use common\modules\master\models\ProductCategory;

$this->title = 'Product Categories';

$subtitle = 'Manage and track all product categories';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?= ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'Product_Category_Export_' . date('YmdHis'),
                ...
                if ($model->status_id == 1) {
                    return Html::a(
                        ...
                        [
                            ...
                            'title' => 'Non Active',
                            'data-title' => 'Non Active Product Category',
                    ...
                    return Html::a(
                        ...
                        [
                            ...
                            'title' => 'Reactivate',
                            'data-title' => 'Reactivate Product Category',
                            'data-name' => $model->name,
                        ]
                    );
                }
...
$(document).on('beforeSubmit', '#productcategory-form', function (e) {
    e.preventDefault();
