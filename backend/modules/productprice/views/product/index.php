...
use common\modules\master\models\Product;

$this->title = 'Products';

$subtitle = 'Manage and track all products you offer';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?= ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'Product_Export_' . date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        [
            ...
            'format' => 'raw',
            'value' => function ($model) {
                return Yii::$app->formatter->asCurrency($model->base_price);
            },
