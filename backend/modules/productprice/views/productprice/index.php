...
use common\modules\master\models\ProductPrice;

$this->title = 'Product Prices';

$subtitle = 'Manage product-specific prices across price lists';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'ProductPrice_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active ProductPrice',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate ProductPrice',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
