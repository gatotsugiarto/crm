...
$this->title = 'Detail '.'Product Prices';
$sub_title = 'Manage product-specific prices across price lists';
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <span><small><?= Yii::$app->formatter->asCurrency($model->price, 'IDR') ?></small></span>
            </div>
