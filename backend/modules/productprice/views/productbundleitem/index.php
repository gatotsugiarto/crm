...
$this->title = 'Product Bundle Items';

$subtitle = 'Manage bundled products and packages';
...
$gridColumns = [
    ...
    //id,
    [
        'attribute' => 'bundle_product_id',
        'value' => function ($model) {
            return Html::encode($model->bundleProduct?->name ?? '-');
        },
    ],
    [
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'ProductBundleItem_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active ProductBundleItem',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate ProductBundleItem',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
...
$(document).on('beforeSubmit', '#productbundleitem-form', function (e) {
    e.preventDefault();
