...
use common\modules\master\models\PriceList;

$this->title = 'Price Lists';

$subtitle = 'Centralized list of product pricing';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'PriceList_Export_'.date('YmdHis'),
...
$(document).on('beforeSubmit', '#pricelist-form', function (e) {
    e.preventDefault();
