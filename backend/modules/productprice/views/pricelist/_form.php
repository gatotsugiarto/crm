...
$title = $isNew ? 'Create New Price List' : 'Edit Price List';
$icon = $isNew ? 'fa-user-plus' : 'fa-edit';

/** @var yii\web\View $this */
/** @var common\modules\productprice\models\PriceList $model */
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new price list.'
                : 'Update price list information below.' ?>
        </small>
    </div>
</div>
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['pricelist/validate'],
    'action' => $isNew ? ['pricelist/create'] : ['pricelist/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
