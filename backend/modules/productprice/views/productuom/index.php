...
$this->title = 'Product UOMs (Units of Measure)';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'ProductUom_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active ProductUom',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate ProductUom',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
...
$(document).on('beforeSubmit', '#productuom-form', function (e) {
    e.preventDefault();
