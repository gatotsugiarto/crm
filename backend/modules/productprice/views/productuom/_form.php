...
$title = $isNew ? 'Create New ProductUom' : 'Edit ProductUom';
$icon = $isNew ? 'fa-user-plus' : 'fa-edit';

/** @var yii\web\View $this */
/** @var common\modules\productprice\models\ProductUom $model */
...
<div class="modal-header bg-default text-white rounded-top-4">
    <div>
        ...
        <small class="text-muted">
            <?= $isNew
                ? 'Please fill in the form below to register a new productuom.'
                : 'Update productuom information below.' ?>
        </small>
    </div>
</div>
...
<?php $form = ActiveForm::begin([
    ...
    // 'validationUrl' => ['productuom/validate'],
    'action' => $isNew ? ['productuom/create'] : ['productuom/update', 'id' => $model->id],
    'options' => ['data-pjax' => 0],
]); ?>
