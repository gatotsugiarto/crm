...
$subtitle = 'Set and control product discounts';
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?=  ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => 'ProductDiscount_Export_'.date('YmdHis'),
...
<?=  GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active ProductDiscount',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate ProductDiscount',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
        ...
        [
            ...
            'value' => function ($model) {
                if($model->discount_type == 'percent'){
                    ...
                    return Yii::$app->formatter->asCurrency($model->discount_value);
                }
            },
            'contentOptions' => ['class' => 'text-right'],
            'headerOptions' => ['class' => 'text-white bg-creative text-right'],
        ],
        'priority',
        'min_qty',
        'valid_from',
        ...
        [
            ...
            'label'          => 'Stackable',
            'format'         => 'raw',
            'value'          => fn($model) => $model->is_stackable
                ? Html::tag('span', '<i class="fa fa-check-circle"></i> Yes', [
                    'class' => 'badge badge-success px-2 py-1',
                ])
                : Html::tag('span', '<i class="fa fa-times-circle"></i> No', [
        ...
        [
            ...
            'buttons' => [
                ...
                'delete' => fn($url, $model) => Html::button('<i class="fa fa-trash"></i>', [
                    ...
                    'data-url' => $url,
                    'data-name' => $model->priceList->name.' - '.$model->product->name,
                ]),
            ],
        ],
    ],
