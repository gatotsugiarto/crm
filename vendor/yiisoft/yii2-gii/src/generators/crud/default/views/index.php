...
$this->title = <?= $generator->generateString(
    Inflector::pluralize(Inflector::camel2words($modelClass))
) ?>;
...
<?php echo "<?php Pjax::begin(['id' => 'w0-pjax']); ?>\n" ?>

<?php echo "<?php"; ?>

<?php
echo "\$gridColumns = [\n";
echo "    ['class' => 'yii\\grid\\SerialColumn'],\n";
echo "    //id,\n";
$count = 0;
    ...
    <div class="d-flex justify-content-between align-items-start mb-2">
        ...
        <div class="d-flex align-items-center">
            <?= "<?= " ?> ExportMenu::widget([
                ...
                'bsVersion' => '4',
                'bootstrap' => true,
                'filename' => '<?= $modelClass ?>_Export_'.date('YmdHis'),
...
<?= "<?= " ?> GridView::widget([
    ...
    'columns' => [
        ...
        //                     'title' => 'Non Active',
        //                     'data-title' => 'Non Active <?= $modelClass ?>',
        ...
        //                     'title' => 'Reactivate',
        //                     'data-title' => 'Reactivate <?= $modelClass ?>',
        //                     'data-name' => $model->employee->fullname,
        //                 ]
        //             );
        //         }
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            ...
            <div class="modal-footer">
                <?php echo "<?=" ?> Html::button('<i class="fa fa-times"></i> Cancel', [
                ...
                <form id="delete-modal-form" method="post">
                    ...
                    <?php echo "<?=" ?> Html::submitButton('<i class="fa fa-trash"></i> Delete', [
        ...
        <div class="modal-content shadow-lg border-0 rounded-4">
            ...
            <div class="modal-footer">
                ...
                <form id="data-url" method="post">
                    <?php echo "<?=" ?> Html::hiddenInput(Yii::$app->request->csrfParam, Yii::$app->request->getCsrfToken()) ?>
                    <?php echo "<?=" ?> Html::submitButton('<i class="fa fa-trash"></i> <span class="data-title"></span>', [
...
$(document).on('beforeSubmit', '#<?= strtolower($modelClass) ?>-form', function (e) {
    e.preventDefault();
