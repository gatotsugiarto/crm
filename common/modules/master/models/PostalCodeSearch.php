...
/**
 * PostalCodeSearch represents the model behind the search form of `common\modules\master\models\PostalCode`.
 */
class PostalCodeSearch extends PostalCode
{
    ...
    {
        return [
            [['id', 'city_id', 'status_id', 'created_by', 'updated_by'], 'integer'],
