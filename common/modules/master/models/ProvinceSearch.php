...
/**
 * ProvinceSearch represents the model behind the search form of `common\modules\master\models\Province`.
 */
class ProvinceSearch extends Province
{
    ...
    {
        return [
            [['id', 'country_id', 'status_id', 'created_by', 'updated_by'], 'integer'],
