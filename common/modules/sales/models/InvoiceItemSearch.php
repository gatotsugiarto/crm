...
/**
 * InvoiceItemSearch represents the model behind the search form of `common\modules\sales\models\InvoiceItem`.
 */
class InvoiceItemSearch extends InvoiceItem
{
    ...
    {
        return [
            [['id', 'invoice_id', 'product_id', 'qty', 'status_id', 'created_by', 'updated_by'], 'integer'],
