...
class SalesOrderItem extends ActiveRecord
{
    ...
    public function behaviors()
    {
        ...
        return [
            ...
            'tokenProtection' => [
                ...
                'sessionKey' => 'salesorderitem_token',
            ],
            [
    ...
    {
        return [
            [['sales_order_id', 'product_id', 'price', 'discount', 'total', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'default', 'value' => null],
            [['status_id'], 'default', 'value' => 1],
            [['sales_order_id', 'product_id', 'qty', 'status_id', 'created_by', 'updated_by'], 'integer'],
